...
export class IncomesComponent implements OnInit {
    ...
    columnDefs: ColDef[] = [
        ...
        },
        {
            ...
            cellStyle: { fontWeight: '600', color: '#3ecf8e', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }
        },
        {
            field: 'date',
            headerName: 'Date',
    ...
    async deleteIncome(id: number) {
        ...
        const confirmed = confirm(`Are you sure you want to delete "${incomeName}"? This action cannot be undone.`);
